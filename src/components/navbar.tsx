    ...
    <>
      ...
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 md:px-6">
          ...
          >
            <div className="relative w-9 h-9 rounded-full bg-gradient-to-br from-primary/20 to-primary/10 flex items-center justify-center transition-all duration-300 group-hover:from-primary/30 group-hover:to-primary/20">
              ...
              <div className="flex flex-col h-full">
                ...
                <div className="p-4 border-t border-border">
                  <p className="text-xs text-muted-foreground text-center">
                    © 2024 DevHamza. All rights reserved.
                  </p>
                </div>
              </div>
            </motion.div>
